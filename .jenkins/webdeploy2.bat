...
%msdeployv2% -verb:sync -source:iisapp="%WORKSPACE%" -dest:iisapp="teamlab.info\blog",computerName="%ComputerName%",username="%username%",password="%password%" -skip:Directory="\\.jenkins" -skip:Directory="teamlab.info\\blog\\wp-content\\uploads" -skip:Directory="teamlab.info\\blog\\wp-content\\cache\\autoptimize" -skip:Directory="teamlab.info\\blog\\wp-content\\temp"
