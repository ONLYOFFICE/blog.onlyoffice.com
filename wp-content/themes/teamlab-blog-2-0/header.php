                    ...
                    <div class="narrowheader">
                        ...
                        elseif (is_search()){
                                ...
                                <form role="search" method="get" class="serach-header" action="<?php bloginfo('home'); ?>/">
								  <div class="input-header">
								  	<input type="text" name="s" id="s" class="search-field" placeholder="Find news, tips and how-tos" value="<?php the_search_query(); ?>"/>
								</div>
								</form>
                          <?php  } ?>
                        </div>
                        ...
                        <nav class="pushy pushy-left">
                            ...
                            <div class="pushy-content">
                                ...
                                --><li class="pushy-submenu"><a class="menuitem <?php echo get_locale();?>" id="navitem_solutions"><?php _e('Solutions', 'tmblog'); ?></a>
                                ...
                                --><li class="pushy-submenu"><a class="menuitem <?php echo get_locale();?>" id="navitem_features"><?php _e('Features', 'tmblog'); ?></a>
