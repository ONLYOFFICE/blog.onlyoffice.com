<?php
/*
Template Name: For main page on site Onlyoffice.
*/
...
<main>
	<div class="ForSiteContainer">
    	...
    	<div id="container" class="pageContent">
          ...
          <?php } ?>
					<h5 class="entry-title"><a href="<?php the_permalink(); ?>" target="_blank" title="<?php printf( esc_attr__( 'Permalink to %s', 'teamlab-blog-2-0' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h5>
					<p><?php the_excerpt() ?></p>
					<div class="meta head">
