...
final class AmphtmlModuleLtsEngineScript extends Tag implements Identifiable
{
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => Element::SCRIPT, SpecRule::SPEC_NAME => 'amphtml module LTS engine script', SpecRule::MANDATORY_ALTERNATIVES => 'amphtml engine script', SpecRule::UNIQUE => \true, SpecRule::MANDATORY_PARENT => Element::HEAD, SpecRule::ATTRS => [Attribute::SRC => [SpecRule::MANDATORY => \true, SpecRule::VALUE => ['https://cdn.ampproject.org/lts/v0.mjs'], SpecRule::DISPATCH_KEY => 'NAME_VALUE_DISPATCH']], SpecRule::ATTR_LISTS => [AttributeList\NonceAttr::ID, AttributeList\AmphtmlModuleEngineAttrs::ID], SpecRule::SPEC_URL => 'https://amp.dev/documentation/guides-and-tutorials/learn/spec/amphtml/#required-markup', SpecRule::CDATA => [SpecRule::WHITESPACE_ONLY => \true], SpecRule::HTML_FORMAT => [Format::AMP], SpecRule::SATISFIES => ['amphtml module LTS engine script'], SpecRule::REQUIRES => ['amphtml nomodule LTS engine script'], SpecRule::ENABLED_BY => [Attribute::TRANSFORMED], SpecRule::DESCRIPTIVE_NAME => 'amphtml module LTS engine script'];
}
