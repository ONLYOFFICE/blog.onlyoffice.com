...
final class IncorrectScriptReleaseVersion extends Error
{
     ...
     * @var array<array>
     */
    const SPEC = [SpecRule::FORMAT => 'The script version for \'%1\' is a %2 version which mismatches with the first script on the page using the %3 version.', SpecRule::SPECIFICITY => 20];
}
