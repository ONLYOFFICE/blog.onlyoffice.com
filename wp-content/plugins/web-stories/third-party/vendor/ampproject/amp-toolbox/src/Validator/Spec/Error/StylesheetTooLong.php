...
final class StylesheetTooLong extends Error
{
     ...
     * @var array<array>
     */
    const SPEC = [SpecRule::FORMAT => 'The author stylesheet specified in tag \'%1\' is too long - document contains %2 bytes whereas the limit is %3 bytes.', SpecRule::SPECIFICITY => 33];
}
