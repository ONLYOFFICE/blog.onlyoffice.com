...
final class AmpBaseCarouselLightboxLightboxExclude extends Tag implements Identifiable
{
     ...
     * @var array
     */
    const SPEC = [SpecRule::TAG_NAME => '$REFERENCE_POINT', SpecRule::SPEC_NAME => 'AMP-BASE-CAROUSEL lightbox [lightbox-exclude]', SpecRule::ATTRS => [Attribute::LIGHTBOX_EXCLUDE => [SpecRule::MANDATORY => \true]], SpecRule::HTML_FORMAT => [Format::AMP]];
}
