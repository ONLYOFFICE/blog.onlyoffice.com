...
final class ScriptAmpSoundcloud extends Tag implements Identifiable, TagWithExtensionSpec
{
     ...
     * @var array
     */
    const EXTENSION_SPEC = [SpecRule::NAME => 'amp-soundcloud', SpecRule::VERSION => ['0.1', 'latest'], SpecRule::DEPRECATED_ALLOW_DUPLICATES => \true, SpecRule::REQUIRES_USAGE => 'EXEMPTED'];
    /**
     * Array of spec rules.
     *
     * @var array
