...
final class CssSyntaxPropertyRequiresQualification extends Error
{
     ...
     * @var array<array>
     */
    const SPEC = [SpecRule::FORMAT => 'CSS syntax error in tag \'%1\' - the property \'%2\' is disallowed unless the enclosing rule is prefixed with the \'%3\' qualification.', SpecRule::SPECIFICITY => 87];
}
