...
final class InconsistentUnitsForWidthAndHeight extends Error
{
     ...
     * @var array<array>
     */
    const SPEC = [SpecRule::FORMAT => 'Inconsistent units for width and height in tag \'%1\' - width is specified in \'%2\' whereas height is specified in \'%3\'.', SpecRule::SPECIFICITY => 45];
}
