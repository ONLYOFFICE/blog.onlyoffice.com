...
trait AMP_Noscript_Fallback
{
    ...
    {
        $this->noscript_fallback_allowed_attributes = \array_fill_keys(\array_keys(AMP_Allowed_Tags_Generated::get_allowed_attributes()), \true);
        foreach (AMP_Allowed_Tags_Generated::get_allowed_tag($tag) as $tag_spec) {
