...
class AMP_Tag_And_Attribute_Sanitizer extends AMP_Base_Sanitizer
{
    ...
    private function is_amp_allowed_attribute(\DOMAttr $attr_node, $attr_spec_list)
    {
        ...
        if (isset($attr_spec_list[$attr_name]) || 'data-' === \substr($attr_name, 0, 5) && Document::AMP_BIND_DATA_ATTR_PREFIX !== \substr($attr_name, 0, 14) || 'html' === $attr_node->parentNode->nodeName && \in_array($attr_node->nodeName, ['amp', '⚡'], \true)) {
            return \true;
        }
