...
class AMP_Validation_Manager
{
    ...
    public static function should_validate_response()
    {
        ...
        $validate_key = wp_unslash($_GET[self::VALIDATE_QUERY_VAR]);
        // phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
    ...
    public static function validate_url($url)
    {
        ...
        $added_query_vars = [self::VALIDATE_QUERY_VAR => self::get_amp_validate_nonce(), self::CACHE_BUST_QUERY_VAR => wp_rand()];
