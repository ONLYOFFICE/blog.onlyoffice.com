...
class Document extends CSSBlockList
{
    ...
    public function render(\Google\Web_Stories_Dependencies\Sabberworm\CSS\OutputFormat $oOutputFormat = null)
    {
        if ($oOutputFormat === null) {
            $oOutputFormat = new \Google\Web_Stories_Dependencies\Sabberworm\CSS\OutputFormat();
        }
