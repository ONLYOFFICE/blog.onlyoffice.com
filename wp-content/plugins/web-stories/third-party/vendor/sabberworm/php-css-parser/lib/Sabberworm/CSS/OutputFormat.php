    ...
    public function __call($sMethodName, $aArguments)
    {
        if (\strpos($sMethodName, 'set') === 0) {
            ...
            if (\strpos($sMethodName, 'get') === 0) {
                ...
                if (\method_exists('Google\\Web_Stories_Dependencies\\Sabberworm\\CSS\\OutputFormatter', $sMethodName)) {
...
class OutputFormatter
{
    ...
    public function implode($sSeparator, $aValues, $bIncreaseLevel = \false)
    {
        ...
        foreach ($aValues as $mValue) {
            ...
            if ($mValue instanceof \Google\Web_Stories_Dependencies\Sabberworm\CSS\Renderable) {
