            ...
            if (\in_array($mValue, array('normal', 'inherit'))) {
                ...
                if (\in_array($mValue, array('italic', 'oblique'))) {
                    ...
                    if ($mValue == 'small-caps') {
                        ...
                        if (\in_array($mValue, array('bold', 'bolder', 'lighter')) || $mValue instanceof Size && \in_array($mValue->getSize(), \range(100, 900, 100))) {
                ...
                if ($mValue instanceof Color) {
                    ...
                    if (\in_array($mValue, array('scroll', 'fixed'))) {
                        ...
                        if (\in_array($mValue, array('repeat', 'no-repeat', 'repeat-x', 'repeat-y'))) {
                            ...
                            if (\in_array($mValue, array('left', 'center', 'right', 'top', 'bottom')) || $mValue instanceof Size) {
                                if ($iNumBgPos == 0) {
