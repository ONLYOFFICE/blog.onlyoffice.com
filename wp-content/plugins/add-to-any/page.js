...
var a2a = a2a || {
    ...
    var a, t, n, i, l, p = o.type,
      ...
      d = function (e, a) {
        if (e && !a2a.in_array(e, s))
          for (var t = 0, n = a ? a2a[p].services : a2a.services, i = n.length; t < i; t++)
  ...
  getPos: function (e, a) {
    ...
    return "undefined" == typeof e.getBoundingClientRect ? a2a.getPosOld(e) : {
      left: n((t = e.getBoundingClientRect()).left - 90),
      top: n(t.top + o)
    }
  },
  ...
  show_menu: function (e, a) {
    ...
    a2a.gEl(g + "_title").value = f.linkname, a2a.toggle_dropdown("block", _), i = [h.clientWidth, h.clientHeight], o = a2a.getDocDims("w"), l = a2a.getDocDims("h"), e ? (n = (t = e.a2a_floating) ? "viewport" : "scroll", h.style.position = t ? "fixed" : "", r = t ? 0 : a2a.getScrollDocDims("w"), s = t ? 0 : a2a.getScrollDocDims("h"), p = (c = e.getElementsByTagName("img")[0]) ? (d = a2a.getPos(c, n), u = c.clientWidth) : (d = a2a.getPos(e, n), u = e.offsetWidth), d.left - r + i[0] + u > o && (d.left = d.left - i[0] + u - 8), ("up" == f.orientation && d.top - s + i[1] + p > l && d.top > i[1]) && (d.top = i[1] - p), h.style.left = (d.left < 0 ? 0 : d.left) + 2 + "px", h.style.top = d.top + p + "px") : (a || (a = {}), h.style.position = a.position || "absolute", h.style.left = a.left || o / 2 - i[0] / 2 + "px", h.style.top = a.top || l / 2 - i[1] / 2 + "px"), a2a[_].doc_click_close_mini || a2a[_].no_hide || (a2a[_].doc_click_close_mini = (m = _, function (e) {
    ...
    if (a2a.type = a2a.c.menu_type || e, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
      a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_html"] = function (e, a) {
        var t, n, r, i, o, l, s = a2a.html_container,
          ...
          k = (document.createElement("a"), f.icon_color),
          w = k ? k.split(",", 2) : k,
          b = w ? w[0] : w,
          x = w ? w[1] : w,
