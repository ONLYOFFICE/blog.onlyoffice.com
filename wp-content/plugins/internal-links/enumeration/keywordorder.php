...
final class KeywordOrder
{
    ...
    public static function translate($value)
    {
        switch ($value) {
        case self::FIFO:
            return __('First configured keyword gets linked first', 'ILJ');
        case self::HIGH_WORDCOUNT_FIRST:
            return __('Highest word count gets linked first', 'ILJ');
        case self::LOW_WORDCOUNT_FIRST:
            return __('Lowest word count gets linked first', 'ILJ');
        }
        return 'N/A';
    }
}
