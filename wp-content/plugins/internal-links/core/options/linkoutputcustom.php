...
class LinkOutputCustom extends AbstractOption
{
    ...
    {
        return __( 'Template for the link output (custom links)', 'ILJ' );
    }
    ...
    {
        return __( 'You can use the placeholders <code>{{url}}</code> for the target and <code>{{anchor}}</code> for the generated anchor text.', 'ILJ' );
    }
