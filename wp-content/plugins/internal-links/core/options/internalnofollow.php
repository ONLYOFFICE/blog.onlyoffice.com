...
class InternalNofollow extends AbstractOption
{
    ...
    {
        return __('NoFollow for internal keyword links', 'ILJ');
    }
    ...
    {
        return __('Sets the <code>rel="nofollow"</code> attribute for keyword links (<strong>not recommended</strong>).', 'ILJ');
    }
