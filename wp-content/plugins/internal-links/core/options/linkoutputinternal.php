...
class LinkOutputInternal extends AbstractOption
{
    ...
    {
        return __('Template for the link output (keyword links)', 'ILJ');
    }
    ...
    {
        return __('Markup for the output of generated internal links.', 'ILJ');
    }
    ...
    {
        return '<p>' . __('You can use the placeholders <code>{{url}}</code> for the target and <code>{{anchor}}</code> for the generated anchor text.', 'ILJ') . '</p>';
    }
}
