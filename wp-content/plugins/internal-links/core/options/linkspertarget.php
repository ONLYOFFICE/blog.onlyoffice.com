...
class LinksPerTarget extends AbstractOption
{
    ...
    {
        return __('Maximum frequency of how often a post gets linked within another one', 'ILJ');
    }
    ...
    {
        return __('For an unlimited number of links, set this value to <code>0</code> .', 'ILJ');
    }
