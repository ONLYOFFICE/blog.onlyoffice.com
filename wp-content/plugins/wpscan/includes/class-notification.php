...
class WPScan_Notification extends WPScan {
  ...
  */
  static public function introduction() {
    ...
    echo '<p>' . __( 'Fill in the options below if you want to be notified by mail about new vulnerabilities. Please note that this will check the API and consume requests. To add multiple e-mail addresses comma separate them.', 'wpscan' ) . '</p>';
