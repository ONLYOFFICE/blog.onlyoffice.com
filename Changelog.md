...
## 1.1.2
### Новое
* Добавлен плагин WP-Discourse, который дублирует записи на https://forum.onlyoffice.com/ в категорию News. Кроме того, плагин изменяет комментирование новых постов. Плагин добавляет кнопку "Join the Discussion" в конце записи, которая ведёт на тестовый форум для обсуждения. Такой способ предполагается использовать для всех новых записей
